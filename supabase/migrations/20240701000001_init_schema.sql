-- ============================================================
-- HOMIFY COMPLETE DATABASE SCHEMA
-- ============================================================
-- This is the ONLY migration file you need for Homify
-- It creates everything required for the app to work
-- ============================================================
...
-- In production, you can make this more restrictive
...
DROP POLICY IF EXISTS "Allow object management" ON storage.objects;
...
-- Create storage policies that work for both buckets
...
-- Success message
SELECT 'Homify database schema created successfully! ✅' AS result;